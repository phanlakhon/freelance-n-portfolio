...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-container section-spacing bg-neutral-50">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="heading-display text-display-md mb-6">
            เริ่มต้นการพูดคุยทางเทคนิค
          </h2>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            สำหรับโปรเจกต์ที่ต้องการความเชี่ยวชาญด้าน Frontend Systems Architecture
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="บอกเล่ารายละเอียดเกี่ยวกับโปรเจกต์ของคุณ..."
                />
              </div>
              ...
              >
                ...
                {status === "idle" && "ส่งข้อความ"}
                {status === "error" && "เกิดข้อผิดพลาด กรุณาลองใหม่"}
              </button>
            </form>
          </motion.div>
          ...
          >
            <div>
              <h3 className="text-xl font-semibold mb-4">ช่องทางการติดต่อ</h3>
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="group-hover:underline">Line ID</span>
                </a>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-neutral-300">
              ...
              <p className="text-neutral-600 mb-2">จันทร์ - ศุกร์: 9:00 - 18:00</p>
              <p className="text-neutral-600 mb-6">เสาร์ - อาทิตย์: ตามนัดหมาย</p>
            ...
            <div className="pt-8 border-t border-neutral-300">
              <p className="text-neutral-700 leading-relaxed">
                หากโปรเจกต์ของคุณต้องการ Frontend Specialist ที่เข้าใจในมุมของ System Architecture และการแก้ปัญหาที่ซับซ้อน สามารถติดต่อเพื่อเริ่มต้นการพูดคุยในเชิงเทคนิคได้ทันที
              </p>
            </div>
          </motion.div>
        </div>
